  ...
  >
    ...
    <div class="row">
      <nav class="filters-modal-nav col-5">
        <ul class="nav flex-column filters-modal-ul" role="tablist">
          ...
          <ul class="filters-modal-body">
            <li class="nav-item filters-modal-list" v-if="inArray('faturamento', enabledFilters)" v-bind:class="{active: 'faturamento' === enabledFilters[0]}">
            ...
            <li class="nav-item filters-modal-list" v-if="inArray('indicadores', enabledFilters)" v-bind:class="{active: 'indicadores' === enabledFilters[0]}">
            ...
            <li class="nav-item filters-modal-list" v-if="inArray('visualizacao', enabledFilters)" v-bind:class="{active: 'visualizacao' === enabledFilters[0]}">
            ...
            <li class="nav-item filters-modal-list" v-if="inArray('week_start_at', enabledFilters)" v-bind:class="{active: 'week_start_at' === enabledFilters[0]}">
      ...
      <div class="col-7 tab-content">
        <div class="tab-pane" id="filtro1" role="tabpanel" v-bind:class="{active: 'faturamento' === enabledFilters[0]}">
        ...
        <div class="tab-pane" id="filtro2" role="tabpanel" v-bind:class="{active: 'indicadores' === enabledFilters[0]}">
          <div class="row tab-header-upper filters-modal-margin-top"></div>
          <div class="row filters-modal-tab-content">
        ...
        <div class="tab-pane" id="filtro3" role="tabpanel" v-bind:class="{active: 'visualizacao' === enabledFilters[0]}">
          <div class="row tab-header-upper filters-modal-margin-top"></div>
        ...
        <div class="tab-pane" id="filtro4" role="tabpanel" v-bind:class="{active: 'week_start_at' === enabledFilters[0]}">
          <div class="row tab-header-upper filters-modal-margin-top"></div>
